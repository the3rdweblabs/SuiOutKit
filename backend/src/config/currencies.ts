...
const FIAT_CURRENCIES: Record<string, FiatCurrency> = {
  NGN: { code: "NGN", symbol: "\u20A6", name: "Nigerian Naira", locale: "en-US", decimals: 0, coingeckoId: "ngn", countryCodes: ["NG"] },
  ...
  JPY: { code: "JPY", symbol: "\u00A5", name: "Japanese Yen", locale: "en-US", decimals: 0, coingeckoId: "jpy", countryCodes: ["JP"] },
  ...
  CLP: { code: "CLP", symbol: "CL$", name: "Chilean Peso", locale: "en-US", decimals: 0, coingeckoId: "clp", countryCodes: ["CL"] },
  ...
  IDR: { code: "IDR", symbol: "Rp", name: "Indonesian Rupiah", locale: "en-US", decimals: 0, coingeckoId: "idr", countryCodes: ["ID"] },
  MYR: { code: "MYR", symbol: "RM", name: "Malaysian Ringgit", locale: "en-US", decimals: 2, coingeckoId: "myr", countryCodes: ["MY"] },
  VND: { code: "VND", symbol: "\u20AB", name: "Vietnamese Dong", locale: "en-US", decimals: 0, coingeckoId: "vnd", countryCodes: ["VN"] },
  ...
  KRW: { code: "KRW", symbol: "\u20A9", name: "South Korean Won", locale: "en-US", decimals: 0, coingeckoId: "krw", countryCodes: ["KR"] },
...
export function getDefaultRate(currency: string): number {
  const defaults: Record<string, number> = {
    NGN: 1300, USD: 1, GBP: 0.79, EUR: 0.92, CAD: 1.36, AUD: 1.53,
    JPY: 149, INR: 83, BRL: 4.97, MXN: 17.15, ZAR: 18.6, KES: 153,
    GHS: 12.2, AED: 3.67, SGD: 1.34, HKD: 7.82, SEK: 10.4, NOK: 10.6,
