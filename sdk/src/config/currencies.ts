...
const FIAT_CURRENCIES: Record<string, FiatCurrencyConfig> = {
  NGN: { code: "NGN", symbol: "\u20A6", locale: "en-US", decimals: 0 },
  ...
  JPY: { code: "JPY", symbol: "\u00A5", locale: "en-US", decimals: 0 },
  ...
  CLP: { code: "CLP", symbol: "CL$", locale: "en-US", decimals: 0 },
  PHP: { code: "PHP", symbol: "\u20B1", locale: "en-US", decimals: 2 },
  THB: { code: "THB", symbol: "\u0E3F", locale: "en-US", decimals: 2 },
  IDR: { code: "IDR", symbol: "Rp", locale: "en-US", decimals: 0 },
  MYR: { code: "MYR", symbol: "RM", locale: "en-US", decimals: 2 },
  VND: { code: "VND", symbol: "\u20AB", locale: "en-US", decimals: 0 },
  ...
  KRW: { code: "KRW", symbol: "\u20A9", locale: "en-US", decimals: 0 },
